...
import DoneStatusTodoList from "../../components/DoneStatusTodoList";
...
export default function Page() {
  ...
  return (
    <div className="w-full">
      <h2 className="text-2xl font-bold my-3">All Done Todos</h2>
      <hr />
      {loading ? (
        <div className="w-full">
          <div
        ...
        <div className="w-full mt-5">
          {data?.todo?.length > 0 ? (
            ...
            <div className="text-center flex flex-col items-center justify-center h-full">
              ...
              <p className="text-2xl">You have no posted/done todo yet.</p>
            </div>
          )}
        </div>
      )}
