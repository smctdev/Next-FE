...
export default function Footer() {
  ...
  return (
    <div className="bg-gray-50 text-sm dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 py-8 md:px-8 w-full overflow-hidden text-gray-800 dark:text-gray-200">
